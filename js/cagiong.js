...
var owl_homeall_img = $("#dvSlideCa");
var owl_homeall_caption = $("#dvSlideCa_Thumbnail");
...
function syncPosition(el) {
    ...
    $("#dvSlideCa_Thumbnail").find(".owl-item")
        .removeClass("current")
        .eq(current)
        .addClass("current");
...
$(window).load(function (e) {
    ...
    $('.proprice_color_group').on('click', 'label.proprice_action', function () {
        ...
        if (priceitem && !$this.hasClass('active')) {
            ...
            //==========
            $('#dvSlideCa').attr('data-color', priceitem.id)
            //==========
            ...
            $('#dvSlideCa img[data-item=prodimg__img1], #dvSlideCa_Thumbnail [data-item=item__1] img').attr('src', priceitem['img']);
